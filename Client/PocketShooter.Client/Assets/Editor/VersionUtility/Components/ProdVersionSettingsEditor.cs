...
{
    public class ProdVersionSettingsEditor : VersionSettingsEditor
    {
        ...
        public override void OnComponentGUI()
        {
            ...
            if (config != null && config.targetObject != null)
            {
                ...
                string warningTitle = "YOU CAN'T SAVE PRODUCTION VERSIONS CONFIGURATION TO \n" + VersionManager.CurrentVersionConfigFilePath;
                EditorGUILayout.HelpBox(warningTitle, MessageType.Warning);
